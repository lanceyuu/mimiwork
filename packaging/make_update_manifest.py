...
uploads):
    ...
    MimiWork-macos-arm64.app.tar.gz(.sig)   -> platforms["darwin-aarch64"]
    MimiWork-macos-x64.app.tar.gz(.sig)     -> platforms["darwin-x86_64"]
    MimiWork-windows-setup.exe(.sig)        -> platforms["windows-x86_64"]
...
ARTIFACTS = {
    "MimiWork-macos-arm64.app.tar.gz": "darwin-aarch64",
    "MimiWork-macos-x64.app.tar.gz": "darwin-x86_64",
    "MimiWork-windows-setup.exe": "windows-x86_64",
}

...
const D: Record<string, [string, string, string]> = {
  ...
  "Visualize this task": ["可视化这个任务", "Visualiser denne oppgaven", "Visualiser cette tâche"],
  ...
  "Add a folder": ["添加文件夹", "Legg til en mappe", "Ajouter un dossier"],
  "No folder yet": ["尚无文件夹", "Ingen mappe ennå", "Aucun dossier pour l'instant"],
  "folder": ["个文件夹", "mappe", "dossier"],
  "folders": ["个文件夹", "mapper", "dossiers"],
  "Mimi works in a temporary space. Add a folder to work on your own files.": [
    "Mimi 目前在临时空间中工作。添加一个文件夹,即可处理你自己的文件。",
    "Mimi jobber i et midlertidig område. Legg til en mappe for å jobbe med dine egne filer.",
    "Mimi travaille dans un espace temporaire. Ajoutez un dossier pour travailler sur vos propres fichiers.",
  ],

...
const BTN_ACCENT = "text-[12.5px] px-3 py-2 rounded-lg bg-ink text-paper shrink-0 disabled:opacity-40";
const BTN_BORDERED =
...
function VoiceInputSection() {
  ...
  return (
    <section>
      ...
      {!desktop ? (
        <div className={CARD + " p-4 text-[13px] text-muted"}>Voice Input setup is available in the MimiWork desktop app.</div>
      ) : (
...
function AppearanceSection() {
  ...
  return (
    <section>
      <PanelHead title="General" sub="How MimiWork looks and behaves on this machine." />
        ...
        <div className={CARD + " p-4"}>
          ...
          <label className="flex items-start gap-3 py-2">
            ...
            <span>
              ...
              <span className="block text-[12px] text-muted">Launch MimiWork automatically when you sign in.</span>
            </span>
          </label>
          <label className="flex items-start gap-3 py-2">

...
TOOL_DEFS: tuple[ConnectorToolDef, ...] = (
    ...
    ConnectorToolDef(
        ...
        "List surveys",
        "read",
        "List surveys in the Qualtrics account.",
    ),
    ConnectorToolDef(
        "qualtrics",
        ...
        "Read questionnaire",
        "read",
        "Read a survey's questions and export column meanings.",
    ),
    ConnectorToolDef(
        "qualtrics",
        ...
        "Fielding progress",
        "read",
        "List a survey's distributions and their response counts.",
    ),
    ConnectorToolDef(
        "qualtrics",
        ...
        "Download responses",
        "write",
        "Download a survey's responses into the session folder.",
    ),
    ConnectorToolDef(
        "linear",
    ...
    # -- canva via Canva's hosted MCP server (one-click path) ----------------------
    # PINNED allowlist, the names as Canva publishes them (canva.dev/docs/mcp/tools,
    # read 2026-09-05). Reads never gate; anything that creates, changes, uploads,
    # or moves is a write and asks first. Exports are renders — a read.
    ConnectorToolDef("canva", "mcp__canva__search-designs", "Search designs", "read", "Find designs by title, content, or metadata."),
    ConnectorToolDef("canva", "mcp__canva__get-design", "Read design", "read", "Read a design's details and share links."),
    ConnectorToolDef("canva", "mcp__canva__get-design-pages", "Read pages", "read", "Read a design's pages."),
    ConnectorToolDef("canva", "mcp__canva__get-design-content", "Read content", "read", "Read the elements on a design."),
    ConnectorToolDef("canva", "mcp__canva__get-design-thumbnail", "Read thumbnail", "read", "Fetch a design's preview image."),
    ConnectorToolDef("canva", "mcp__canva__get-presenter-notes", "Read notes", "read", "Read a presentation's presenter notes."),
    ConnectorToolDef("canva", "mcp__canva__get-export-formats", "Export formats", "read", "List the formats a design can be exported to."),
    ConnectorToolDef("canva", "mcp__canva__export-design", "Export design", "read", "Render a design to PDF, PNG, JPG, PPTX, GIF, or MP4."),
    ConnectorToolDef("canva", "mcp__canva__resolve-shortlink", "Resolve link", "read", "Expand a canva.link short URL."),
    ConnectorToolDef("canva", "mcp__canva__generate-design", "Generate design", "write", "Create a new design from a brief."),
    ConnectorToolDef("canva", "mcp__canva__create-design-from-candidate", "Pick a candidate", "write", "Turn a generated candidate into a design."),
    ConnectorToolDef("canva", "mcp__canva__copy-design", "Copy design", "write", "Duplicate a design."),
    ConnectorToolDef("canva", "mcp__canva__import-design-from-url", "Import from URL", "write", "Import a file at a URL as a design."),
    ConnectorToolDef("canva", "mcp__canva__resize-design", "Resize design", "write", "Resize a design to new dimensions (Pro)."),
    ConnectorToolDef("canva", "mcp__canva__start-editing-transaction", "Start editing", "write", "Open an editing session on a design."),
    ConnectorToolDef("canva", "mcp__canva__perform-editing-operations", "Edit design", "write", "Change elements inside an editing session."),
    ConnectorToolDef("canva", "mcp__canva__commit-editing-transaction", "Save edits", "write", "Save an editing session to the design."),
    ConnectorToolDef("canva", "mcp__canva__cancel-editing-transaction", "Discard edits", "write", "Discard an editing session."),
    ConnectorToolDef("canva", "mcp__canva__get-assets", "List assets", "read", "List uploaded assets."),
    ConnectorToolDef("canva", "mcp__canva__upload-asset-from-url", "Upload asset", "write", "Upload an image at a URL to your assets."),
    ConnectorToolDef("canva", "mcp__canva__search-folders", "Search folders", "read", "Find folders by name."),
    ConnectorToolDef("canva", "mcp__canva__list-folder-items", "List folder", "read", "List what a folder holds."),
    ConnectorToolDef("canva", "mcp__canva__create-folder", "Create folder", "write", "Create a folder."),
    ConnectorToolDef("canva", "mcp__canva__move-item-to-folder", "Move item", "write", "Move a design or asset into a folder."),
    ConnectorToolDef("canva", "mcp__canva__list-comments", "Read comments", "read", "Read the comments on a design."),
    ConnectorToolDef("canva", "mcp__canva__list-replies", "Read replies", "read", "Read the replies in a comment thread."),
    ConnectorToolDef("canva", "mcp__canva__comment-on-design", "Comment", "write", "Comment on a design as you."),
    ConnectorToolDef("canva", "mcp__canva__reply-to-comment", "Reply", "write", "Reply in a comment thread as you."),
    ConnectorToolDef("canva", "mcp__canva__search-brand-templates", "Brand templates", "read", "Find brand templates (Pro)."),
    ConnectorToolDef("canva", "mcp__canva__list-brand-kits", "Brand kits", "read", "List brand kits (Pro)."),
    ConnectorToolDef("canva", "mcp__canva__create-design-from-brand-template", "From template", "write", "Create a design from a brand template (Pro)."),
    ConnectorToolDef("canva", "mcp__canva__get-brand-template-dataset", "Template fields", "read", "Read a brand template's autofill fields (Enterprise)."),
    ConnectorToolDef("canva", "mcp__canva__autofill-design", "Autofill", "write", "Fill a brand template with data (Enterprise)."),
)

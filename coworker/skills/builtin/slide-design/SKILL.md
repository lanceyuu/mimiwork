---
name: slide-design
description: Slide design — create stunning, animation-rich HTML presentations from scratch or by converting PowerPoint files. Use when the user wants a beautifully designed presentation, a talk or pitch deck with real visual polish, or a PPT/PPTX converted to web slides. Helps non-designers discover their aesthetic through visual exploration rather than abstract choices.
---

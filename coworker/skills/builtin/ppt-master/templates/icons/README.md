...
> **MimiWork vendor note**: `tabler-outline` (5,138 line icons) and `simple-icons`
> (3,675 brand logos) are not bundled, to keep the app small. If a design needs
> them, download that folder from the official repo
> (https://github.com/hugohe3/ppt-master, `skills/ppt-master/templates/icons/`)
> into this directory and every documented flow works unchanged.
